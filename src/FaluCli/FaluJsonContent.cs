...
internal class FaluJsonContent<TValue> : HttpContent
{
    ...
    public FaluJsonContent(TValue inputValue, JsonTypeInfo<TValue> jsonTypeInfo, MediaTypeHeaderValue? mediaType = null)
    {
...
internal static class FaluJsonContent
{
    public static FaluJsonContent<TValue> Create<TValue>(TValue inputValue, JsonTypeInfo<TValue> jsonTypeInfo, MediaTypeHeaderValue? mediaType = null)
